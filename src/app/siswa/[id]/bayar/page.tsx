...
export default function BayarPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (success) {
    return (
      <main style={shellStyle}>
        <div style={pageStyle}>
          <section className="card" style={{ ...headerStyle, textAlign: "center" }}>
    ...
    <main style={shellStyle}>
      <div style={pageStyle}>
        <section className="card" style={headerStyle}>
          ...
          <div style={{ fontSize: 18, fontWeight: 700, color: "#173b1a", marginTop: 12 }}>Pembayaran SPP</div>
          <div style={{ color: "#5f6f63", fontSize: 13, marginTop: 4 }}>
            Kirim bukti transfer untuk diverifikasi admin.
          </div>
        </section>
        ...
        {siswa && (
          <div className="card">
            ...
            <div style={{ fontSize: 13, color: "#757575" }}>NISN {siswa.nisn} | Kelas {siswa.kelas}</div>
