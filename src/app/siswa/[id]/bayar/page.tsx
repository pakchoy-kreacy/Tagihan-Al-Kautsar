...
import { ArrowLeft, Home, Wallet, Banknote, QrCode, Copy, Check, Upload, X } from "lucide-react"
  ...
  return (
    <div className="app-shell">
      ...
      <main className="public-page with-bottom-btn">
        ...
        <div
          className={`method-option ${method === "transfer" ? "active" : ""}`}
        ...
        <div
          className={`method-option ${method === "qris" ? "active" : ""}`}
        ...
        {method === "transfer" && !bank && (
          <div className="card" style={{ marginTop: 14 }}>
            <p className="empty-text">Info rekening belum tersedia</p>
          </div>
        )}
        ...
        {method === "qris" && !bank?.qris_url && (
          <div className="card" style={{ marginTop: 14 }}>
            <p className="empty-text">QRIS belum tersedia</p>
          </div>
        )}
